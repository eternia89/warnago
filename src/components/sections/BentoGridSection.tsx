    ...
    >
      ...
      <div className="container mx-auto px-5 relative">
        <div className="grid grid-cols-[1fr_1.5fr_1fr] max-lg:grid-cols-[1fr_1fr] gap-10 max-sm:grid-cols-1 max-sm:gap-4">
          ...
          <div className="bento-card relative rounded-[300px_300px_0_0] overflow-hidden h-[320px] max-sm:h-[200px]">
            <Image
              src={image2}
          ...
          <div className="bento-card bg-warnago-green rounded-[0_0_0_180px] aspect-square max-md:hidden flex items-center justify-center text-white p-10 text-center font-head font-medium text-xl h-[320px] max-sm:h-[200px]">
            Jaminan warna akurat dengan mesin tinting modern yang
            dikalibrasi berkala
          </div>

          {/* Cell 5: tagline text */}
          <div className="bento-card text-white rounded-2xl h-[320px] max-sm:h-[200px] flex items-center justify-center p-6">
          ...
          <div className="bento-card relative rounded-[400px_0_0_400px] overflow-hidden h-[320px] max-sm:h-[200px]">
            <Image
              src={image3}
          ...
          <div className="bento-card relative rounded-[180px_0_180px_0] overflow-hidden h-[320px] max-sm:h-[200px] ">
            <Image
              src={image4}
          ...
          <div className="bento-card bg-warnago-yellow mx-auto rounded-[0_400px_400px_0] aspect-square max-md:hidden flex items-center justify-center text-[#987D01] p-10 text-center font-head font-medium text-xl h-[320px] max-sm:h-[200px]">
            Display produk modern memudahkan Anda menemukan pilihan
            warna yang tepat
          </div>

          {/* Cell 9: image-3 (interior) */}
          <div className="bento-card relative rounded-[0_240px_0_0] overflow-hidden h-[320px] max-sm:h-[200px]  max-md:hidden">
            <Image
              src={image5}
